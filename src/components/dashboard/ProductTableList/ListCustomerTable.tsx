      ...
      {numSelected > 0 ? (
        ...
        <Box sx={{ flex: '1 1 100%', display: 'flex', justifyItems: 'center', alignItems: 'center' }}>
          <TextField
            ...
            value={search}
          />
          <CustomerAdd btnVisiblity={true} dialogTitle={"Add New Customer"} btnLbl={"Add Customer"}  modal={addModal} setModal={setAddModal} />
...
const CustomerListTable = () => {
  ...
  return (
    <Box>
      <Box>
    <CustomerAdd dialogTitle={"Modification For Customer"} btnLbl={"Add Customer"} btnVisiblity={false} setModal={setModifyModal} modal={modify} />
