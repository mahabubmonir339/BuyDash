...
import { AdminPanelSettings, Assessment, Autorenew, Category, CoffeeMaker, Handyman, Map, People, Settings, SupervisorAccount, Tune } from '@mui/icons-material';
...
const Menuitems: MenuitemsType[] = [
  ...
  {
    id: uniqueId(),
    title: 'Machines Reports',
    icon: Assessment,
    href: '/dashboard/machines/reports',
  },
  {
    navlabel: true,
  ...
  },
  {
    ...
    href: '/dashboard/admininstrator/users',
  ...
  },
  {
    ...
    title: 'Email Setting',
    icon:Tune,
    href: '/dashboard/administrator/email-settings',
  },

  {
    ...
    title: 'Tools',
    icon: Handyman,
    href: '/dashboard/administrator/tools',
  }
